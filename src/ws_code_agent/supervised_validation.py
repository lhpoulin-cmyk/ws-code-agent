...
TASK11N_VISIBLE_VALIDATION_ID = "task11n-ws-doc-writer-writing-setup-visible-v1"
TASK11N_HIDDEN_VALIDATION_ID = "task11n-ws-doc-writer-writing-setup-hidden-v1"
TASK11N_VALIDATION_IDS = (
    TASK11N_VISIBLE_VALIDATION_ID,
    TASK11N_HIDDEN_VALIDATION_ID,
)
...
TASK11N_VISIBLE_SOURCE = REGISTRY_ROOT / f"{TASK11N_VISIBLE_VALIDATION_ID}.py"
TASK11N_HIDDEN_SOURCE = REGISTRY_ROOT / f"{TASK11N_HIDDEN_VALIDATION_ID}.py"
...
def validation_registry() -> dict[str, ValidationDescriptor]:
    ...
    task11n_visible = ValidationDescriptor(
        TASK11N_VISIBLE_VALIDATION_ID,
        "v1",
        "/usr/bin/python3",
        ("-B", str(TASK11N_VISIBLE_SOURCE)),
        ".",
        10,
        ValidationRole.VISIBLE,
        True,
    ...
    task11n_hidden = ValidationDescriptor(
        TASK11N_HIDDEN_VALIDATION_ID,
        "v1",
        "/usr/bin/python3",
        ("-B", str(TASK11N_HIDDEN_SOURCE)),
        ".",
        10,
        ValidationRole.HIDDEN_ORACLE,
        True,
...
def descriptor_source(descriptor_id: str) -> Path:
    sources = {
        ...
        TASK11N_VISIBLE_VALIDATION_ID: TASK11N_VISIBLE_SOURCE,
        TASK11N_HIDDEN_VALIDATION_ID: TASK11N_HIDDEN_SOURCE,
    }
    try:
